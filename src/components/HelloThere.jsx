...
function HelloThere() {
  ...
  return (
    <div className="relative flex w-screen h-screen border border-red-500">
      ...
      <div className="absolute inset-x-0 inset-y-0 m-auto w-full max-w-lg h-1/4">
        ...
        <div className="absolute -top-1 -right-4 w-72 h-72 bg-indigo-700 rounded-full mix-blend-lighten filter blur-2xl opacity-70 animate-blob animation-delay-2000">
        </div>
        <div className="absolute -top-4 -right-15 w-72 h-72 bg-violet-800 rounded-full mix-blend-lighten filter blur-2xl opacity-70 animate-blob animation-delay-6000">
        </div>
