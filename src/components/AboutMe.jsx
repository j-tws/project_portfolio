...
function AboutMe(){
  ...
  return (
    ...
    <div id="aboutme" className="rounded-lg flex flex-col-reverse items-center w-3/4 py-10 mx-auto mt-10 space-y-0 md:space-y-0 md:flex-row bg-[#0d1321]">
      <div className="max-w-2xl flex flex-col px-5 w-6/8 m-auto md:w-10/12 md:max-w-1/3">
        ...
        <img className="rounded-full mx-6 m-auto w-1/2 md:mx-auto md:w-72" src="/img/IMG_6258.jpg" alt="profile_img" />
