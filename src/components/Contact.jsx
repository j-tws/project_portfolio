...
function Contact(){
  ...
  return (
    <div className="m-5 md:mx-auto md:m-10 md:w-2/3 md:p-12 border border-red-500">
      <h2 className="mx-auto my-3 text-5xl font-primary text-amber-400 font-bold text-center">Get in Touch</h2>
      ...
      <a className='text-white px-2 py-1 border border-amber-300 rounded hover:bg-amber-300/40 md:px-4 md:py-2'>Contact Me</a>
    </div>
  )
